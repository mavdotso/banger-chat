    ...
    return (
        <div className="mx-auto flex flex-col gap-6 justify-center w-full max-w-lg items-center h-[95vh] px-6">
            {!showPrivacyPage ? (
                <Form {...form}>
                    <form className="w-full flex flex-col py-4 gap-1.5 text-start" onSubmit={(...args) => void form.handleSubmit(handleSecurity)(...args)}>
                        <div className="flex flex-col gap-1 justify-center items-center w-full">
                            ...
                            <span className="leading-7 text-muted-foreground ">Customize your Threads profile</span>
                            ...
                            <Button type="submit" className="w-full rounded-xl bg-foreground hover:bg-foreground select-none text-white dark:text-black">
                                Continue &rarr;
                            </Button>
                        </div>
                    </form>
                ...
                <div className="flex flex-col gap-1 justify-center items-center w-full">
                    <h2 className="scroll-m-20 tracking-wide text-4xl font-bold">Privacy</h2>
                    <span className="leading-7 text-muted-foreground text-center ">Your privacy can be different on Threads and Instagarm.</span>
                        ...
                        <div>
                            ...
                            >
                                <div className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    <h1 className="text-base dark:text-slate-100 text-black font-medium">Public profile</h1>
                                    <Globe className="w-5 h-5" />
                                </div>
                                <span className="max-w-[350px]">Anyone on or off Threads can see, share and interact with your content.</span>
                            </Label>
                        </div>
                        <div>
                            ...
                            >
                                <div className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    <h1 className="text-base dark:text-slate-100 text-black font-medium">Private profile</h1>
                                    <Lock className="w-5 h-5" />
                                </div>
                                <span className="max-w-[350px]">Only your approved followers can see, share and interact with your content.</span>
                            </Label>
                        </div>
                    </RadioGroup>
                    <Button className="w-full mt-4 rounded-xl bg-foreground hover:bg-foreground select-none text-white dark:text-black" onClick={handleAccountSetup} disabled={isLoading}>
