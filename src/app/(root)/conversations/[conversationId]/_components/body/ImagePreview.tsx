                        ...
                        >
                            <DialogTrigger asChild>
                                {isVideo ? (
                                    ...
                                    <Image src={url} alt={`Uploaded image`} referrerPolicy="no-referrer" className="rounded-md" layout="fill" objectFit="cover" />
                                )}
                            </DialogTrigger>
                            <DialogContent>
                                <DialogHeader>
                                ...
                                <div className="w-full h-96 relative flex items-center justify-center">
                                    {isVideoFile(url) ? (
                                        ...
                                        <Image src={url} alt={`Uploaded image`} referrerPolicy="no-referrer" layout="fill" objectFit="contain" />
                                    )}
                                </div>
                            </DialogContent>
                        </div>
