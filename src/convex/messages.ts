...
export const get = query({
    ...
    handler: async (ctx, args) => {
        ...
        const membership = await ctx.db.query('conversationMembers').withIndex('by_memberId_conversationId', (q) => q.eq('memberId', currentUser._id).eq('conversationId', args.id));
